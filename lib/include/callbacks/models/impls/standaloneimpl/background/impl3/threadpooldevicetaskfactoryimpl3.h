...
#include "callbacks/models/impls/standaloneimpl/background/threadpooldevicetaskfactory.h"
#include <callbacks/export.h>


class CALLBACKS_EXPORT ThreadPoolDeviceTaskFactoryImpl3: public ThreadPoolDeviceTaskFactory {
 public:
