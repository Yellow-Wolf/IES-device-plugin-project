# CMake package config file for widgets library.
#
...
####### The input file was widgets-config.cmake.in                            ########
...
macro(import_targets type)
    if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/widgets-${type}-targets.cmake")
        set(${CMAKE_FIND_PACKAGE_NAME}_NOT_FOUND_MESSAGE "widgets ${type} libraries were requested but not found")
        set(${CMAKE_FIND_PACKAGE_NAME}_FOUND OFF)
        return()
    endif()

    include("${CMAKE_CURRENT_LIST_DIR}/widgets-${type}-targets.cmake")
endmacro()

if(NOT TARGET widgets::widgets)
    set(type "")
    ...
    elseif(BUILD_SHARED_LIBS AND EXISTS "${CMAKE_CURRENT_LIST_DIR}/widgets-shared-targets.cmake")
        set(type "shared")
    elseif(EXISTS "${CMAKE_CURRENT_LIST_DIR}/widgets-static-targets.cmake")
        set(type "static")
    else()
        set(type "shared")
    endif()
    ...
    message("-- Found ${type} widgets (version ${${CMAKE_FIND_PACKAGE_NAME}_VERSION})")
endif()
