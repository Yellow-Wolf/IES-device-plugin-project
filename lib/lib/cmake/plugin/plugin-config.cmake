# CMake package config file for plugin library.
#
...
####### The input file was plugin-config.cmake.in                            ########
...
macro(import_targets type)
    if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/plugin-${type}-targets.cmake")
        set(${CMAKE_FIND_PACKAGE_NAME}_NOT_FOUND_MESSAGE "plugin ${type} libraries were requested but not found")
        set(${CMAKE_FIND_PACKAGE_NAME}_FOUND OFF)
        return()
    endif()

    include("${CMAKE_CURRENT_LIST_DIR}/plugin-${type}-targets.cmake")
endmacro()

if(NOT TARGET plugin::plugin)
    set(type "")
    ...
    elseif(BUILD_SHARED_LIBS AND EXISTS "${CMAKE_CURRENT_LIST_DIR}/plugin-shared-targets.cmake")
        set(type "shared")
    elseif(EXISTS "${CMAKE_CURRENT_LIST_DIR}/plugin-static-targets.cmake")
        set(type "static")
    else()
        set(type "shared")
    endif()
    ...
    message("-- Found ${type} plugin (version ${${CMAKE_FIND_PACKAGE_NAME}_VERSION})")
endif()
