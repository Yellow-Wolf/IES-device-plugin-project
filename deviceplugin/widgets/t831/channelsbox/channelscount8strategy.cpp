...
#include "channelscount8strategy.h"

void ChannelsCount8Strategy::initUI(std::vector<ChannelButton*> *buttons, QGroupBox *channels_box) {
    channels_count = 8;

    channels_box->setFont(header_group_box_font);
    channels_box->setFixedSize(500, 150);
